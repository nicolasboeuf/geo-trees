    ...
    <div id="content">
      ...
      <div class="content-section section-white" v-if="aboutData">
        <div class="content-wrapper">
          ...
          <div class="partners-logo-list x-small-logo">
            <a class="partner-logo" v-for="member in sitePartners" v-bind:key="member.name" :href="member.link" target="_blank"><img :src="'https://geo-trees.org/geo-trees/img/'+member.image"/></a>
          </div>

          <h2>Supporting Partners</h2>
          <div class="partners-logo-list x-small-logo">
            <a class="partner-logo" v-for="member in supportingPartners" v-bind:key="member.name" :href="member.link" target="_blank"><img :src="'https://geo-trees.org/geo-trees/img/'+member.image"/></a>
          </div>
...
export default {
  ...
  computed: {
    executiveBoard(){
      return this.aboutData.filter(member => member.group === "executive-board" && member.display === "yes");
    },
    projectManager(){
      return this.aboutData.filter(member => member.group === "project-manager" && member.display === "yes");
    },
    scientificBoard(){
      return this.aboutData.filter(member => member.group === "scientific-board" && member.display === "yes");
    },
    networksPartners(){
      return this.aboutData.filter(member => member.group === "networks-partners" && member.display === "yes");
    },
    sitePartners(){
      return this.aboutData.filter(member => member.group === "site-partners" && member.display === "yes");
    },
    supportingPartners(){
      return this.aboutData.filter(member => member.group === "supporting-partners" && member.display === "yes");
    },
    community(){
      return this.aboutData.filter(member => member.group === "community" && member.display === "yes");
    },
    aboutData(){
